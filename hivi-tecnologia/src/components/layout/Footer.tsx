      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-3 text-xs text-[#CBD5E1]">{t('footer.tagline')}</p>
            ...
            <div className="mt-6 space-y-2">
              ...
              {process.env.NEXT_PUBLIC_EMAIL_CONTATO && (
                <a
                  href={`mailto:${process.env.NEXT_PUBLIC_EMAIL_CONTATO}`}
                  className="flex items-center gap-2 text-sm text-[#CBD5E1] transition-colors hover:text-white"
                >
            ...
            <div className="mt-4 flex gap-3">
              {SOCIAL_LINKS.map(({ key, href, Icon, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[#1565C0]"
                >
                  <Icon />
                </a>
              ))}
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-xs text-[#CBD5E1]">
            © {year} HIVI Tecnologia — {t('footer.rights')}
          </p>
        </div>
      </div>
    </footer>
